...
class wordFilterPlugin {
  function __construct() {
    add_action('admin_menu', array($this, 'plugMenu'));
    add_action('admin_init', array($this, 'optionSettings'));
  ...
  function mainPageAssets() {
    wp_enqueue_style('filterAdminCss', plugins_url('styles.css', __FILE__));
    ...
    <div class="wrap">
      ...
      <form action="" method="POST">
        ...
        <label for="plugin_words_to_filter">
          <p>Enter a <strong>comma-sepertated</strong> list of words to filter from your site's content</p>
          <div class="word-filter__flex-container">
            <textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="bad, mean, horrible, awful"><?php echo esc_textarea(get_option('plugin_words_to_filter')) ?></textarea>
          </div>
